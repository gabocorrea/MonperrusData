...
fdout = open("../out/possible_non_directives.csv","w")
fdout2 = open("../out/dataset_withID_without_directives.csv","w")
...
#fdout.write("id,type,path,apidoc_Text\n")
fdout2.write("id,type,path,apidoc_Text\n")
with open("../data/dataset_withID.csv") as fdDataset:
	...
	for line in fdDataset:
		...
		if i not in list_of_directives_id:
